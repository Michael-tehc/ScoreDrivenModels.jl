...
function IPNewton(
    ...
    IPNewton{T}(f_tol, g_tol, ub, lb, iterations, initial_points)
end
...
optimize(func::Optim.TwiceDifferentiable, opt_method::IPNewton, verbose::Int, i::Int, time_limit_sec::Int) =
    optimize(
        func, opt_method,
        Optim.TwiceDifferentiableConstraints(opt_method.lb, opt_method.ub),
        Optim.IPNewton(), verbose, i, time_limit_sec
    )
